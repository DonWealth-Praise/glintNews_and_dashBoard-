            ...
            <div class="container-fluid d-flex align-items-center justify-content-between">
                <div class="navbar-header">
                    ...
                    <a href="index.html" class="navbar-brand">
                        <div class="brand-text brand-big visible text-uppercase"><strong class="text-primary">Glint</strong><strong>News24</strong></div>
                        <div class="brand-text brand-sm"><strong class="text-primary">G</strong><strong>N</strong></div>
                    </a>
                    <!-- Sidebar Toggle Btn-->
    ...
    <div class="d-flex align-items-stretch">
        ...
        <nav id="sidebar">
            ...
            <ul class="list-unstyled">
                ...
                <li>
                    <a href="{{ route('login') }}"> <i class="icon-logout"></i>Logout </a>
                </li>
            ...
            <footer class="footer">
                <div class="footer__block block no-margin-bottom">
                    <div class="container-fluid text-center">
                        <p class="no-margin-bottom">2024 &copy; Glint New. All Rights Reserved. Tech by <a target="_blank" href="https://teranium.co" > Teranium Co &rightarrowtail;</a></p>
                    </div>
                </div>
            </footer>
        </div>
